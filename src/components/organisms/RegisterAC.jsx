...
const tiposConocimiento = [
  "Proyectos", "Publicaciones", "Bases de datos", "Protocolos", "Tablas",
  "Fotos", "Videos", "Métodos desarrollados o mejorados", "Manuales",
  "Prototipos", "Herramientas tecnológicas", "Muestras biológicas", "Software",
  "Productos", "Patentes", "Marcas registradas", "Actas de inicio de proyectos",
  "Eventos organizados", "Memorias Eventos", "Trabajos presentados en eventos",
  "Premios y distinciones", "Archivos de prensa", "Trabajos de grado", "Informes",
  "Saberes", "Experiencias"
];
const formatos = ["PDF", "DOI", "EXCEL", "VIDEOS", "Word", "JPG", "JPEG", "PNG", "GIF", "TIFF", "BMP", "MP3", "MP4", "FÍSICOS", "URL"];
